...
{
    public class HUDKeyNumbersSprite : IHUD
    {
        public Link link;
        ...
        public HUDKeyNumbersSprite(SpriteBatch spriteBatch, Vector2 location, Link link)
        {
        ...
        {
            int tensDigit = hudMethods.FindTensDigit(link.numKeys);
            switch (tensDigit)
            {
                case 0:
            ...
            Draw();
            int onesDigit = hudMethods.FindOnesDigit(link.numKeys);
            switch (onesDigit)
            {
                case 0:
                    sourceRectangle = hudMethods.GetZeroSourceRectangle();
