...
{
    public class HUDGemNumbersSprite : IHUD
    {
        public Link link;
        ...
        public HUDGemNumbersSprite(SpriteBatch spriteBatch, Vector2 location, Link link)
        {
        ...
        {
            int tensDigit = hudMethods.FindTensDigit(link.numGems);
            switch (tensDigit)
            {
                case 0:
            ...
            Draw();
            int onesDigit = hudMethods.FindOnesDigit(link.numGems);
            switch (onesDigit)
            {
                case 0:
                    sourceRectangle = hudMethods.GetZeroSourceRectangle();
