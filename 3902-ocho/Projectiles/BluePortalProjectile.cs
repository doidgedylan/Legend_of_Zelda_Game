...
{
    public class BluePortalProjectile : IProjectile
    {
        ...
        public BluePortalProjectile(SpriteBatch spriteBatch, Vector2 location, string direction)
        {
        ...
        public void Draw()
        {
            ...
            LocationRect = new Rectangle((int)Location.X, (int)Location.Y, width/ xScale, height / yScale);
        ...
        public void SetStartLocation()
        {
            ...
            {
                case "up":
                    Location = Vector2.Add(Location, new Vector2(2 * xScale, 0));
                    Location = Vector2.Subtract(location, new Vector2(0, 18 * yScale));
                    break;
                case "right":
                    Location = Vector2.Add(Location, new Vector2(18 * 3, 0));
                    break;
                case "down":
                    Location = Vector2.Add(Location, new Vector2(2 * xScale, 18 * yScale));
                    break;
                case "left":
                    Location = Vector2.Subtract(Location, new Vector2(21 * xScale, 0));
                    break;
                default:
                    break;
            }
